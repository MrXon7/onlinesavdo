...
class CartItemCard extends StatelessWidget {
  ...
  const CartItemCard({super.key, required this.cartItem, required this.isOrdered});
                ...
                : Row(
                    children: [
                      IconButton(
                          onPressed: () {
                            Provider.of<CartProvider>(context, listen: false)
                                .decreaseQuantity(cartItem.product.id, user!.id);
                          },
                      ...
                      IconButton(
                          onPressed: () {
                            Provider.of<CartProvider>(context, listen: false)
                                .increaseQuantity(cartItem.product.id, user!.id);
                          },
